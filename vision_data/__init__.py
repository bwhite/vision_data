...
def hbase_loader(prefix, dataset, thrift_server, thrift_port):
...
def picarus_loader(prefix, dataset, email, picarus_server, api_key=None, login_key=None, otp=None, download=False, test=False):
    import hadoopy_hbase
    import picarus
    dataset = DATASETS[dataset]()
    if download:
